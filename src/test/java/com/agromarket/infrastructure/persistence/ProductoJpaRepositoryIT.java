...
public class ProductoJpaRepositoryIT {
    ...
    public void saveFindDelete_productoEntity() {
        ProductorEntity productor = ProductorEntity.builder()
                ...
                .telefono("3000000001")
                .build();
        ProductorEntity savedProd = (ProductorEntity) usuarioJpaRepository.save(productor);
        ...
        assertThat(productoJpaRepository.findById(saved.getId())).isPresent();

        productoJpaRepository.deleteById(saved.getId());
        assertThat(productoJpaRepository.findById(saved.getId())).isNotPresent();
    }
}
