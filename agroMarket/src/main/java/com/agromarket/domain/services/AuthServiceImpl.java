...
public class AuthServiceImpl implements AuthService {
    ...
    private final com.agromarket.domain.ports.CuponDescuentoService cuponService;
    ...
    public void verificarEmail(String token) {
        ...
        if (usuario.getRol() == RolUsuario.COMPRADOR && !isEmpresa) {
            ...
            com.agromarket.application.persistence.sql.entities.CuponDescuento cupon = cuponService.generarCuponPrimerEnvio(usuario.getId());
