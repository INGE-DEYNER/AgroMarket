...
import com.agromarket.domain.ports.AdminService;
...
public class AdminServiceImpl implements AdminService {
    ...
    private final com.agromarket.domain.ports.EmailService emailService;
    ...
    @Override
    public com.agromarket.application.api.response.PageResponse<UsuarioResponse> usuarios(int page, int size, String search) {
        ...
        return com.agromarket.application.api.response.PageResponse.<UsuarioResponse>builder()
                .content(content)
    ...
    public List<UsuarioResponse> productoresPendientes() {
        List<UsuarioEntity> pendientes = usuarioJpaRepository.findByRolAndAprobadoFalse(com.agromarket.domain.models.enums.RolUsuario.PRODUCTOR);
    ...
    public byte[] getReportePdf() {
        try (java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream()) {
            ...
            List<com.agromarket.application.persistence.sql.entities.ProductoEntity> productos = productoJpaRepository.findAll();
            int pCount = 0;
            alternate = false;
            for (com.agromarket.application.persistence.sql.entities.ProductoEntity p : productos) {
                if (pCount++ >= 10) break;
                java.awt.Color rowBg = alternate ? lightGrayBg : java.awt.Color.WHITE;
    ...
    @Override
    public com.agromarket.application.api.response.PageResponse<com.agromarket.application.api.response.ProductoResponse> productos(int page, int size, String search) {
        org.springframework.data.domain.Pageable pageable = org.springframework.data.domain.PageRequest.of(Math.max(0, page), Math.max(1, size), org.springframework.data.domain.Sort.by(org.springframework.data.domain.Sort.Direction.DESC, "id"));
        org.springframework.data.domain.Page<com.agromarket.application.persistence.sql.entities.ProductoEntity> pageResult;
        if (search != null && !search.isBlank()) {
            org.springframework.data.jpa.domain.Specification<com.agromarket.application.persistence.sql.entities.ProductoEntity> spec = (root, query, cb) -> cb.like(cb.lower(root.get("nombre")), "%" + search.toLowerCase() + "%");
            pageResult = productoJpaRepository.findAll(spec, pageable);
        } else {
            pageResult = productoJpaRepository.findAll(pageable);
        }
        java.util.List<com.agromarket.application.api.response.ProductoResponse> content = pageResult.getContent().stream().map(productoMapper::toResponse).collect(java.util.stream.Collectors.toList());
        return com.agromarket.application.api.response.PageResponse.<com.agromarket.application.api.response.ProductoResponse>builder()
                .content(content)
                .page(pageResult.getNumber())
                .size(pageResult.getSize())
    ...
    @Override
    @org.springframework.transaction.annotation.Transactional(readOnly = true)
    public com.agromarket.application.api.response.ReporteFinanzasResponse getReporteFinanzas() {
        ...
        return com.agromarket.application.api.response.ReporteFinanzasResponse.builder()
    ...
    @Override
    @org.springframework.transaction.annotation.Transactional(readOnly = true)
    public com.agromarket.application.api.response.ReporteLogisticaResponse getReporteLogistica() {
        java.util.List<com.agromarket.application.persistence.sql.entities.EnvioEntity> envios = envioJpaRepository.findAll();
        ...
        for (com.agromarket.application.persistence.sql.entities.EnvioEntity e : envios) {
        ...
        return com.agromarket.application.api.response.ReporteLogisticaResponse.builder()
