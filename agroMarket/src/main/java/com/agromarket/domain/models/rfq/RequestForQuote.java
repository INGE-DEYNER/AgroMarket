...
public class RequestForQuote {
    ...
    /**
     * Estado actual de la solicitud de cotización.
     */
    @Builder.Default
    private RequestForQuoteStatus status = RequestForQuoteStatus.OPEN;
    ...
    /**
     * Verifica si la solicitud de cotización está abierta.
     *
     * @return true si la solicitud está en estado OPEN
     */
    public boolean isOpen() {
        return status == RequestForQuoteStatus.OPEN;
    }

    /**
     * Verifica si la solicitud de cotización continúa activa.
     *
     * <p>Se mantiene este método para compatibilidad con código existente
     * que utilizaba el antiguo atributo boolean active.</p>
     *
     * @return true si la solicitud está abierta
     */
