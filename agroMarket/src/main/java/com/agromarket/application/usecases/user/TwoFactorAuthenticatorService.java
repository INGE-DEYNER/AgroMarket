...
/**
 * Servicio que gestiona la autenticación de dos factores (2FA).
 * Implementa la generación de secretos TOTP, verificación de códigos
 * y generación de URLs OTPAuth para aplicaciones de autenticación.
 * 
