      ...
      <div className={`chatbot-window ${isOpen ? "open" : ""}`}>
        <div className="chatbot-header">
          <div className="chatbot-header-info">
            ...
            <div>
              <h4 className="chatbot-title">{t("support.title")}</h4>
              <p className="chatbot-status">{t("support.online")}</p>
            </div>
          </div>
          <button
        ...
        <div className="chatbot-body">
          ...
          {loading && (
            <div className="chat-message bot">
              <div className="message-bubble">{t("support.thinking")}</div>
            </div>
          )}
          <div ref={endRef} />
        </div>
            ...
            <div className="chips-container">
              {QUICK_KEYS.map((key) => (
                ...
                >
                  {t(
                    `support.quick.${key}`,
                    t(`support.quickQuestions.${key}`, key),
                  )}
                </button>
              ))}
            </div>
