    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Conectamos a pequeños productores de frutas tropicales de Urabá
            directamente con fruterías, empresas y familias colombianas de
            manera transparente.
          </p>
        </div>
        <div
      ...
      >
        ...
        >
          ...
          >
            Nuestra plataforma utiliza un sistema de **Fideicomiso Comercial
            (Escrow)**. Cuando compras un producto, tu dinero no va directamente
            al productor de inmediato. Lo retenemos de manera segura hasta que
            confirmas que has recibido tus frutas tropicales frescas y a
            satisfacción. De este modo, protegemos la inversión de los
            compradores y garantizamos el pago de los agricultores.
          </p>
          <div
            style={{
              display: "flex",
      ...
      >
        ...
        >
          Explora nuestro catálogo y apoya directamente a los productores
          locales hoy.
        </p>
        <Link
          to="/catalogo"
