    ...
    >
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          >
            Productores certificados de la región del Urabá Antioqueño que
            garantizan la máxima frescura del campo a tu mesa.
          </p>
        </div>
        ...
        {!loading && !error && productores.length === 0 && (
          ...
          >
            ...
            >
              Pronto habrá productores aquí
            </h3>
            <p style={{ fontSize: "1rem", marginBottom: "20px" }}>
              Los productores de ASAFRUT están registrándose en la plataforma.
              ¡Vuelve pronto!
            </p>
            <div
              style={{
            ...
            >
              ...
              <Link
                to="/registro?rol=PRODUCTOR"
                style={{
                  background: "white",
                  color: "var(--primary, #385723)",
                  padding: "12px 24px",
                  borderRadius: "10px",
                  textDecoration: "none",
                  fontWeight: "600",
                  border: "2px solid var(--primary, #385723)",
                }}
              >
        ...
        {!loading && !error && productores.length > 0 && (
          ...
          >
            {productores.map((p, idx) => {
              ...
              const ubicacion =
                p.ubicacion || p.ciudad || p.municipio || "Urabá, Antioquia";
              const foto = p.fotoUrl || p.foto || p.imagenUrl || null;
              const frutas = p.productos || p.cultivos || [];
              const calificacion =
                p.calificacionPromedio ?? p.calificacion ?? null;
              const bio =
                p.bio ||
                p.descripcion ||
                p.experiencia ||
                "Productor certificado de la región del Urabá Antioqueño.";
                ...
                >
                  <div
                    style={{
                      ...
                      height: "220px",
                      background:
                        "linear-gradient(135deg, #385723 0%, #2d6a4f 100%)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      overflow: "hidden",
                  ...
                  >
                    {calificacion && (
                      ...
                      >
                        ...
                        {Number(calificacion).toFixed(1)} · Productor
                        Certificado
                      </span>
                    )}
                    <h3
        ...
        {!loading && (
          <div
            style={{
              ...
              marginTop: "60px",
              padding: "40px",
              background: "linear-gradient(135deg, #385723 0%, #2d6a4f 100%)",
              borderRadius: "20px",
              color: "white",
            }}
          >
            <h2 style={{ fontSize: "1.8rem", marginBottom: "10px" }}>
              ¿Eres productor de ASAFRUT?
            </h2>
            <p style={{ opacity: 0.85, marginBottom: "24px" }}>
              Únete a la plataforma y vende tus productos directamente a
