...
export default function Catalogo() {
  ...
  const { addToCart, count, setCartOpen } = useCart();
  ...
  const handleContactProductor = (producto) => {
    ...
    const prodName =
      ...
      "Productor";
    navigate(
      `/dashboard-comprador?section=mensajeria&contactId=${prodId}&contactName=${encodeURIComponent(prodName)}`,
    );
  };
  ...
  }, [page, search, filtroTipo, minPrice, maxPrice, soloPromo, t]);
      ...
      <div className="catalog-page">
        <div className="catalog-container">
          ...
          <div className="catalog-hero">
            <div className="catalog-hero-text">
              ...
              <p className="catalog-hero-sub">
                {t(
                  "catalog.bannerSub",
                  "Compra frutas y verduras a precios de productor sin intermediarios con trazabilidad total.",
                )}
              </p>
            </div>
          ...
          <div className="catalog-layout-grid">
            ...
            <div
              className={`card-table catalog-filters-sidebar ${showFiltersMobile ? "open" : ""}`}
            >
              <h4
                style={{
                  fontSize: "0.95rem",
          ...
          {!loading && !error && (
            <div className="catalog-meta">
              <p className="catalog-meta-count">
                ...
                {filtered.length === 1
                  ? t("catalog.resultsFound", "producto encontrado")
                  : t("catalog.resultsFoundPlural", "productos encontrados")}
          ...
          {!loading && totalPages > 1 && (
            ...
            >
              <button
                className="btn-cta"
                style={{
                  background: page === 0 ? "#ccc" : "var(--primary)",
                  color: "#fff",
                  border: "none",
                  padding: "8px 16px",
                  borderRadius: "6px",
              ...
              <button
                ...
                style={{
                  background:
                    page === totalPages - 1 ? "#ccc" : "var(--primary)",
                  color: "#fff",
                  border: "none",
                  padding: "8px 16px",
                  borderRadius: "6px",
