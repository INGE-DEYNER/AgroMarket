...
const es = [
  ...
  { id: "language", keywords: ["idioma", "lenguaje", "ingles", "espanol", "language", "no cambia el idioma", "traduccion"], answer: "Para cambiar el idioma abre el selector (ES) en la barra superior y elige entre Espanol e Ingles. Mas idiomas estaran disponibles en proximas actualizaciones; si eliges uno no disponible veras un aviso." },
...
const en = [
  ...
  { id: "language", keywords: ["language", "english", "spanish", "translation", "does not change"], answer: "Open the language selector (ES) in the top bar and choose between Spanish and English. More languages will be available in upcoming updates; if you pick an unavailable one you will see a notice." },
