  ...
  const handleRetry = async () => {
    ...
    try {
      const res = await fetch(
        (import.meta.env.VITE_API_URL || 'http://localhost:8080/api') + '/actuator/health',
  ...
  return (
    <div style={{
      ...
      >
        ...
        {/* Signal bars (crossed) */}
        <rect x="155" cy="10" x1="148" y1="90" x2="168" y2="90" width="3" height="8"  rx="1.5" fill="#ccc" y="90"/>
        <rect x="158" width="3" height="12" rx="1.5" fill="#ccc" y="86"/>
        <rect x="162" width="3" height="16" rx="1.5" fill="#ccc" y="82"/>
        <line x1="145" y1="82" x2="170" y2="100" stroke="#ef5350" strokeWidth="3" strokeLinecap="round"/>
        <line x1="170" y1="82" x2="145" y2="100" stroke="#ef5350" strokeWidth="3" strokeLinecap="round"/>
      </svg>

      <div style={{ textAlign: 'center', maxWidth: '380px' }}>
        <h2 style={{
          fontSize: '22px', fontWeight: '700',
          color: '#1b4332', marginBottom: '10px',
          fontFamily: "'Outfit', sans-serif",
        }}>
          Sin conexión con AgroMarket
        </h2>
        <p style={{ color: '#4a5568', fontSize: '15px', lineHeight: '1.6' }}>
          No podemos comunicarnos con el servidor en este momento.
