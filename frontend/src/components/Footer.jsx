    ...
    <footer className="footer-pro">
      ...
      <div className="footer-main">
        <div className="footer-col">
          <Link to="/home" className="footer-logo" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none', color: 'inherit' }}>
            <img
              src="/logo-asafrut.jpg"
              alt="Logo ASAFRUT"
              style={{ height: '48px', width: 'auto', borderRadius: '8px', objectFit: 'contain' }}
            />
            <span style={{ fontWeight: '700', fontSize: '1.25rem' }}>AgroMarket</span>
          </Link>
          <p className="footer-tagline">Del campo de Urabá a tu mesa.</p>
          <p className="footer-desc">
            Plataforma oficial de ASAFRUT — Asociación Agropecuaria El Sabor de las Frutas y el Campo.
        ...
        <div className="footer-col">
          ...
          <button
            type="button"
            onClick={openChatbot}
            style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', color: 'inherit', textDecoration: 'none', fontSize: 'inherit', textAlign: 'left' }}
          >
            Centro de ayuda
          </button>
        ...
        <div className="footer-col">
          ...
          <div className="footer-social">
            ...
            <a
              href="https://wa.me/573100000000?text=Hola%2C+necesito+ayuda+con+AgroMarket"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp de AgroMarket"
            >
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
      ...
      <div className="footer-bottom">
        ...
        <span>Hecho con <svg viewBox="0 0 24 24" width="14" height="14" fill="#ef4444" style={{ display: 'inline', verticalAlign: 'middle', margin: '0 2px' }}><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg> en Colombia · Desarrollado por Deyner Chaverra</span>
      </div>
    </footer>
  );
}
