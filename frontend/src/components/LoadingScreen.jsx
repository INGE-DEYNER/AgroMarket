...
export default function LoadingScreen() {
  ...
  useEffect(() => {
    ...
    return () => { timers.forEach(clearTimeout); clearTimeout(textTimer); };
  }, []);

  return (
    <div style={{
      position: 'fixed', inset: 0, zIndex: 9999,
      background: 'linear-gradient(160deg, #0d2b16 0%, #1a3d1f 50%, #12341a 100%)',
      ...
      {/* Logo with pulse */}
      <div style={{ animation: 'pulseSoft 2s ease-in-out infinite', position: 'relative' }}>
        <img
      ...
      {/* Progress bar */}
      <div style={{ width: '200px', display: 'flex', flexDirection: 'column', gap: '8px', alignItems: 'center' }}>
        <div style={{
